module.exports = {
    ...
    changelog: "Added Leave Server Mod ~ aoe#9022",
    ...
    html: function(data) {
        return `
            <div class="form-group">
                ...
                <textarea class="form-control needed-field" name="messagecolor" rows="3" ></textarea>
            </div>
            <div class="form-group">
                <label>Set the Title that shows up in the embed that will be send on leave *</label>
                <textarea class="form-control needed-field" name="messagetitle" rows="3" ></textarea>
            </div>
            <div class="form-group">
                <label>Set the Description that shows up in the embed that will be send on leave *</label>
                <textarea class="form-control needed-field" name="messagedesc" rows="3" ></textarea>
            </div>
        `;
    },
